...
function validate() {
  ...
  document.myForm.month.value.length != 2 || document.myForm.month.value > 12  || document.myForm.month.value <= 0){
   ...
   if( document.myForm.date.value == "" || document.myForm.date.value > 31 || document.myForm.date.value <= 0) {
   if( document.myForm.date.value == "" || isNaN( document.myForm.month.value ) || 
